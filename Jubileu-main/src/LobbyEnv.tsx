...
import { Door, WallPanel, CeilingLight, Armchair, TallPlant, FloorLamp, ReceptionDesk } from './BuildingBlocks';
...
export const LobbyNPC = ({ positionRef, isPaused, playerPositionRef }: any) => {
  ...
  const aiState = useRef({ state: 'Idle', target: new Vector3(0, 0, 0), timer: 0 });
