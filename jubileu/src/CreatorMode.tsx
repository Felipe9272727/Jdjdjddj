...
export const FLOORS: FloorOption[] = [
  ...
  },
  {
    ...
    level: 13,
    variant: 'entidade',
    name: 'Vindhjem — a ENTIDADE',
    label: 'Andar 13',
    description: 'Duas pistas e diante de Halvard: fale com ele e a entidade acorda.',
    color: 'from-amber-600 via-sky-500 to-emerald-400',
    icon: <span aria-hidden="true">▚</span>,
  },
  {
    id: 'floor-13-casaCerta',
    level: 13,
    variant: 'casaCerta',
    name: 'Vindhjem — a casa certa',
    label: 'Andar 13',
