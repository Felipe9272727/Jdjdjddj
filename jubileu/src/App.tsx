...
import { configureFloor8Sfx, clearFloor8Sfx, startFloor8Ambient } from './floor8Sfx';
...
export default function App() {
  ...
  useEffect(() => { if (currentLevel === 4 || currentLevel === 5 || currentLevel === 6 || currentLevel === 8) setZoomLevel(0); }, [currentLevel]);
  ...
  useEffect(() => {
    if (currentLevel !== 8 || !audioCtx) return;
    configureFloor8Sfx(audioCtx, cartoonBusRef.current);
    if (!muted) startFloor8Ambient();
    return () => clearFloor8Sfx();
  }, [currentLevel, audioCtx, muted]);
