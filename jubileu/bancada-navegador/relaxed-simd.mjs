...
for (const pacote of PACOTES) {
    ...
    const r = await page.evaluate(async ({ base, pacote, persona, pergunta, n }) => {
        ...
        const uma = async () => {
            ...
            const res = await w.createChatCompletion({
                messages: msgs, n_predict: n, temp: 0, cache_prompt: true, ignore_eos: true,
            });
    ...
    }, { base: BASE, pacote, persona: PERSONA, pergunta: PERGUNTA, n: N });
    await page.close();
